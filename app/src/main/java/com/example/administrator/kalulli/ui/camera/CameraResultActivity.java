                ...
                file.saveInBackground(new SaveCallback() {
                    ...
                    public void done(AVException e) {
                        if (e == null) {
                            ...
                            avObject.put(TableUtil.DAILY_FOOD_CALORIE, calorie);
                            avObject.put(TableUtil.DAILY_FOOD_INFO, info);
                                            ...
                                            public void done(List<AVObject> list, AVException e) {
                                                if (list == null || list.size() == 0){
                                                    ...
                                                    if (ComputerTypeUtil.getType().equals("早餐")){
                                                        avObject1.put(TableUtil.DAILY_MORNING,calorie);

                                                    }else if (ComputerTypeUtil.getType().equals("午餐")){
                                                        avObject1.put(TableUtil.DAILY_AFTERNOON,calorie);

                                                    }else{
                                                        avObject1.put(TableUtil.DAILY_EVENING,calorie);
                                                    }
