...
public class TableUtil {
    ...
    public static final String USER_TELEPHONE = "mobilePhoneNumber";
    public static final String USER_HEIGHT = "height";
    public static final String USER_WEIGHT = "weight";
    public static final String USER_LOVE = "love";
    public static final String USER_STICK = "stick";
    ...
    public static final String DAILY_MORNING = "morning";
    public static final String DAILY_AFTERNOON = "afternoon";
    public static final String DAILY_EVENING = "evening";
    public static final String DAILY_USER = "user";
    //dailyfood
